...
class SeldModel(BaseModel):
    ...
    def common_step(self, batch_data):
        """
        Common functions/methods used in training, validation and test steps
        Takes input data and outputs predictions along with corresponding ground truth values
        """
    ...
    def training_step(self, train_batch, batch_idx):
        """
        Methods used in the training loop (training the model)
        """
    ...
    def training_epoch_end(self, training_step_outputs):
        """
        What to do at the end of each training epoch
        """
    ...
    def validation_step(self, val_batch, batch_idx):
        """
        Methods used in the validation loop
        """
    ...
    def validation_epoch_end(self, validation_step_outputs):
        """
        What to do at the end of each validation epoch
        """
    ...
    def test_step(self, test_batch, batch_idx):
        """
        Methods used in testing loop
        """
        target_dict, pred_dict = self.common_step(test_batch)
    ...
    def test_epoch_end(self, test_step_outputs):
        """
        What to do at then end of each testing loop
        """
        pred_filenames = os.listdir(self.submission_dir)
        pred_filenames = [fn for fn in pred_filenames if fn.endswith('csv')]
    ...
    # This is the same code as common_step
    #######################################

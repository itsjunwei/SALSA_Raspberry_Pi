...
def build_database(cfg):
    ...
    feature_db = dataset.Database(feature_root_dir=cfg.feature_root_dir, gt_meta_root_dir=cfg.gt_meta_root_dir,
...
def build_datamodule(cfg, feature_db, inference_split: str = None):
    ...
    """
    datamodule = dataset.SeldDataModule(feature_db=feature_db, split_meta_dir=cfg.split_meta_dir, mode=cfg.mode,
...
def build_task(encoder, decoder, cfg, output_pred_dir: str = None, submission_dir: str = None,
    ...
    model = models.SeldModel(encoder=encoder, decoder=decoder, sed_threshold=cfg.sed_threshold,

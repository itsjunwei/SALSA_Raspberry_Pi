...
def inference(exp_config: str = './configs/seld_salsa_lite.yml',
    ...
    build_feature_database_time = timer() - start_time
    ...
    load_datamodule = timer() - start_time
    ...
    with open("./outputs/crossval/mic/salsa/seld_salsa_lite_test/logs/timelog.txt", 'w') as f:
        ...
        f.write("Loading Model              : {:.3f}s\n".format(load_model))
        f.write("Loading Trainer            : {:.3f}s\n".format(load_trainer))

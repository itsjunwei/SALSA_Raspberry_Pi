...
def train(
            exp_config: str = './configs/seld_salsa_lite.yml',
    ...
    # Tensorboard logger
    ## Logger Name should include metrics we want to track in the future
    tb_log_name = "BatchSize-{}-MaxEpochs-{}".format(cfg.training.train_batch_size, cfg.training.max_epochs)
    tb_logger = TensorBoardLogger(save_dir=cfg.dir.tb_dir, name=tb_log_name)
